    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="team.php">Installer</a></li>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container ">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="./Admin/serviceimages/<?= $image?>" class="img-fluid" alt="" style="width: 100%; height: 400px;">
              <div class="portfolio-info">
                <p><?=$name?></p>
                <div class="portfolio-links">
                  <a href="./Admin/serviceimages/<?= $image?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.php?sid=<?=$sid?>" class="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <?php
                ...
                echo '<nav aria-label="Page navigation" style="margin-bottom: 8px; position: relative; left: 45%; top: 55%;"';

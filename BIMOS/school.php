  ...
  <div class="container d-flex align-items-center">
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li><a href="school.php" class="active">School</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="./Admin/courseimage/<?=$image?>" class="img-fluid" alt="" style = "width: 100%; height: 150px;"></div>
              <div class="member-info">
                <h4><?=$courses_name?></h4>
                <span><?=$courses_price?></span>
                <p><?=$courses_duration?></p>
                <div class="social">
          ...
          ?>
              ...
              <?php
                ...
                echo '<nav aria-label="Page navigation" style="margin-bottom: 8px; position: relative; left: 45%;"';

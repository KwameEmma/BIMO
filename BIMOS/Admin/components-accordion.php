    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Trainers Page</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      ...
      <center>
       ...
       <div class="container card" style = "width: 100%;">
        <h5 class="card-title" style = "width: 100%;">Trainers Table</h5>
          ...
          <tbody>
            <?php
               //Pagination for a page
                  ...
                  $total_records_query = mysqli_query($con, "SELECT COUNT(*) AS total FROM trainner_tbl");
                  ...
                  $records_query = mysqli_query($con, "SELECT * FROM trainner_tbl LIMIT $offset, $records_per_page");
                  $counter = 0;
                 while($row = mysqli_fetch_array($records_query,MYSQLI_ASSOC)){
                    ...
                    echo "<tr class='btnv'>
                    <td>$counter</td>
                    <td><img src = 'trainersimage/$image' style = 'width: 60%; height: 50px; border-radius: 100%;'></td>
                    <td>$t_name</td>
                    <td>$t_contact </td>
                    <td>$t_email</td>
                    <td>$t_address</td>
                    ...
                    <a href = 'deletetrainer.php?t_id=$t_id'>
...
<div class="">
    <div class="card-body">
      <form action="trainerserver.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <input type="text" class="form-control" name="t_name" placeholder="Trainer's Name" required><br>
              <input type="text" class="form-control" name="t_contact" placeholder="Trainer's Contact" required><br>
              <input type="text" class="form-control" name="t_email" placeholder="Trainer's Email" required><br>
              <input type="text" class="form-control" name="t_address" placeholder="Trainer's Address" required><br>
              <input type="text" class="form-control" name="t_course" placeholder="Course" required><br>
  ...
  <script src="assets/vendor/php-t_nametion-form/validate.js"></script>

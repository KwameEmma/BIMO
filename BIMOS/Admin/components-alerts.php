            ...
            <?php
                  ...
                  $counter = 0;
                    while($row = mysqli_fetch_array($records_query,MYSQLI_ASSOC)){
                        ...
                        <a href = 'deletecourse.php?cid=$cid'>
...
<div class="">
    <div class="card-body">
      <form action="uploadcourse.php" method="post" id="myForm" enctype="multipart/form-data" novalidate>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <input type="text" class="form-control" name="courses_name" id="courses_name" placeholder="Course Name" required><br>
              <input type="text" class="form-control" name="courses_duration" id="courses_duration" placeholder="Course Duration" required><br>
              <input type="text" class="form-control" name="courses_price" id="courses_price" placeholder="Course Price" required><br>
              <input type="text" class="form-control" name="student_id" id="student_id" placeholder="Student ID" required><br>
              <input type="file" class="form-control" name="filename" id="filename" required><br>
            </div>
  ...
  <!-- <script src="toastr/build/toastr.js.map"></script> -->
  ...
  <!-- <script src="assets/vendor/php-courses_duration-form/validate.js"></script> -->
  ...
  $.ajax({
    ...
    error: function(xhr, status, error) {
      ...
      // Handle error and display an appropriate message or toast notification

...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center active" href="users-profile.php">
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="images/<?= $row['image'];?>" alt="Profile" class="rounded-circle" style = "width: 100%;">
              <h2><?= $row['fullname'];?></h2>
              <h3><?= $row['email'];?></h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">BIMOS</div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="images/<?= $row['image'];?>" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="company" type="text" class="form-control" id="company" value="BIMO">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="aid" type="hidden" class="form-control" id="newPassword" value="<?= $row['aid'];?>">
                      </div>
                    </div>
  ...
  $.ajax({
    url: 'resetpassword.php', // Replace with the correct PHP file handling password reset
    type: 'POST',
    data: data,

...
<body>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Uploaded Pictures</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class = "section">
      ...
      <center>
          ...
          <div class="container card" style = "width: 100%;">
            <h5 class="card-title" style = "width: 100%;">Picture Table</h5>
            ...
            <table id="example" class="table table-striped">
              ...
              <tbody>
                <?php
                  ...
                  $total_records_query = mysqli_query($con, "SELECT COUNT(*) AS total FROM picture_tbl");
                  ...
                  $records_query = mysqli_query($con, "SELECT * FROM picture_tbl LIMIT $offset, $records_per_page");
                  $counter = 0;
                  ...
                  echo "<tr class='btnv'>
                  <td>$counter</td>
                  <td><img src = 'picture/$image' style = 'width: 50%; height: 50px; border-radius: 100%;'></td>
                  <td>$name</td>
                  <td>
                  
                  <a href = 'forms-layouts.php?id=$id'> 
                  <input type = 'submit' name = 'edit' value = 'Edit' class = 'btn btn-outline-primary' style = 'margin: 3px;' data-bs-toggle='modal' data-bs-target= '#disabledAnimation'>
                  </a>
                  <a href = 'deletepicture.php?id=$id'> 
                  <input type = 'submit' name = 'delete' value = 'Delete' class = 'btn btn-outline-danger' style = 'margin: 3px;'>
                  </a>
 ...
 <!-- Upload Modal -->
  <div class="">
    <div class="card-body">
    <form action="uploadpicture.php" method="POST" enctype="multipart/form-data" novalidate>
      <h5 class="card-title">Upload Picture</h5>
      <div class="modal fade" id="disablebackdrop" tabindex="-1" data-bs-backdrop="false">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Upload Picture Information</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <input type="text" class="form-control" name="name" placeholder="Picture Name" required><br>
...
<!-- End of Modal -->
  ...
  <div class="modal" id="disabledAnimation" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
       <form action="uploadcourse.php" method="POST" enctype="multipart/form-data" novalidate>
        <div class="modal-header">
          <h5 class="modal-title">Edit Picture Information</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
        <input type="text" class="form-control" name="courses_name" value = "<?=$courses_name?>" placeholder="Course Name" required><br>
        <input type="file" class="form-control" name="filename" value = "<?=$image?>" required><br>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>

...
<body>
    ...
    <section class = "section">
      ...
      <center>
          ...
          <div class="container card" style = "width: 100%;">
            <h5 class="card-title" style = "width: 100%;">Videos Table</h5>
            ...
            <table id="example" class="table table-striped">
              ...
              <tbody>
                <?php
                  ...
                  $total_records_query = mysqli_query($con, "SELECT COUNT(*) AS total FROM video_tbl");
                  ...
                  $records_query = mysqli_query($con, "SELECT * FROM video_tbl LIMIT $offset, $records_per_page");
                  $counter = 0;
                  while($row = mysqli_fetch_array($records_query,MYSQLI_ASSOC)){
                        ...
                        echo "<tr class='btnv'>
                        <td>$counter</td>
                        <td><video src = 'videos/$video' style = 'width: 60%; height: 70px; border-radius: 100%;'></video></td>
                        <td>$name</td>
                        <td>
                        ...
                        <a href = 'deletevideo.php?vid=$vid'>
 ...
 <!-- ======= Footer ======= -->
  ...
  <div class="">
    <div class="card-body">
      <form action="videoupload.php" method="POST" enctype="multipart/form-data" novalidate>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <input type="text" class="form-control" name="name" placeholder="Video Name" required><br>
